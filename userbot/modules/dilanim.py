...
DİLANIM_STRINGS = [
    ...
    "Bundan sonra artık hayatında Dilan'ım diye biri yok!",
    ...
    "Lan sus sende sabahtan beri Dilanım Dilanım dmdkdmdmdmföfögö",
...
@register(outgoing=True, pattern="^.dilanim$")
async def dilanim(e):
    """ Dilan'ımın sözlüğü """
    await e.edit(choice(DILANIM_STRINGS))


CMD_HELP.update({
    "dilanim":
    ".dilanim veya .dilanim ile birinin metnine cevap verin.\
    \nKullanım: Dilan'ımdan alıntılar."
})
