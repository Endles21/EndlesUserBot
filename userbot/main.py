...
UNAPPROVED_MSG = ("`Hey! Bu bir EndlesUserBot. Endişelenme.\n\n`"
...
try:
    ...
    PLUGIN_MESAJLAR = {}
    ORJ_PLUGIN_MESAJLAR = {"alive": "`Merhaba EndlesUserBot Çalışıyor...`", "afk": str(choice(AFKSTR)), "kickme": "Güle Güle ben gidiyorum 🤠", "pm": UNAPPROVED_MSG, "dızcı": str(choice(DIZCILIK_STR))}
...
LOGS.info("Botunuz çalışıyor! Herhangi bir sohbete .alive yazarak Test edin."
          " Yardıma ihtiyacınız varsa, Destek grubumuza gelin t.me/EndlesSupport")
LOGS.info("Bot sürümünüz Endles v1.3")
